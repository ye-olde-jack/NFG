...
- # Step 4: PCs current goals and plans (Major Restructure this) (In Progress.)
	...
	- What are they trying to get to or where are they trying to go?
		...
		- Levi is trying to get to the Shepherd's Gate and then make sure Petra is safe, before leaving Outer City. Wants to get to town to learn more about contamination.
		- Emile is trying to get to the Shepherd's Gate and then make sure Petra is safe, before leaving Outer City.
	- What are they trying to accomplish?
		- **Thalia** wants to keep people safe and uphold her values, even at the cost of herself.
			- Short Term:
				- Gonna be training for the most part. No place for her to do so at the Silver Order, Hendrix Farm however does have some. Lame, maybe spice up with visit to combat grounds for the Dawn Duels at first light.
					- Potential Clarence or Mallory interaction. Remark is there too. :)
		- **Rupert** wants to destroy delerium and fight monsters.
			- Short term: 
				- Figure out how to destroy Delerium.
				- Wants to see if he can train his constitution in order to resist contamination better.
		...
		- **Levi** is trying to further his own goals.
			- Short term:
		...
		- **Emile** is trying to get new leads and make it back to Emberwood safely.
			- Short Term:
				...
				- Learn about the Kramer Records that Tobias has, as well as follow up on more leads.
			- Mid Term:
				- Gain a trusted contact for each of the factions if possible
			- Long Term:
				- Finding and arresting Kramer.
	- Determine who, if anyone, is trying to stop them.
		- Mobius - James Ockman might try to stop Dr. Mobius from doing some experimenting while within his rental property, stating that if he does then he might have to start renting a room somewhere. If he does magic in public, it's likely not a good thing.
		- Emile - River is going to be made suspicious of him by Remark.
		- Levi - Kuromi is going to want to stop Levi from doing shit with River because that bitch is crazy.
		- Levi - River might attempt to stop Levi from leaving down if he doesn't succeed a stealth check when trying to leave.
			- Step 7.
...
- Downtime:
	- Emile:
		- Secured rifle.
		- Rolled 21 on persuasion check for getting Ophelia Reed and Captain Ansom in the same room.
			- Next session:
				- 
	- Levi:
		- Talks to River about Academy Ring.
		- Talked with River regarding contamination, acknowledged contaminant.
			- Next session:
				- Note to Jupiter Jack says, 'Fear the Anon.'
	- Mobius:
		- Gives River delerium crystal.
		- Learns Delerium has thousands of known isotopes.
			- Next session:
				- 
	- Rupert:
		- Visit the Dawn Duels for further sway in Silver Order.
		- Learned about Oscar Yoren.
			- Next session:
				- 
	- Thalia:
		- Nat twenty on animal handling, gained half proficiency.
		- Wants to do Dawn Duel.
			- Next session:
				- 
