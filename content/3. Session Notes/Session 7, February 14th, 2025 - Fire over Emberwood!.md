...
- Traveled towards [[Shepherd's Gate]], avoiding some [[Hooded Lanterns]] traps. They noted some odd storm taking place forming above the eastern side of the Outer City.
	- Spoke about delerium powered aircraft from [[Doctor Archivel Gecker Mobius]].
	- Noted a [[Gnolls]] attack at the gate.
- On the way back after receiving some minor supplies from [[Lieutenant Petra Lang]], they saw trinket from [[Levi SlaughterDale]] react to the storm.
...
- Split up once you all got back to [[Emberwood Village]].
	- [[Rupert McNamara]] had a short talk with [[Thalia Bleakheart]] about her inner light and then resolved to keep her secret, going to bed after.
...
- Emile went to the [[Old Watchtower]].
	- Spoke with [[Captain Ansom Lang]], informed that [[Lieutenant Petra Lang]] was safe and received gratitude briefly and then again later in the morning. This included a new rifle in the form of the Mk. II 'Hamstring'.
		- This rifle has ties to eastern Drakkenheim during the Civil War.
	- [[Emile D'Arlan]] then went to the [[Bark & Buzzard]], collect some rumors on how the conflict in the [[Chapel of Saint Ardenna]] was spun, improvised pilgrimage, [[Knights of the Silver Order]] provision attempting to go after these improper Pilgrims to little success, and this was due to unforeseen new monsters.
- Levi went to talk with Erin in the midst of the [[Midnight Court]], a version of the caravan court turned black market.
	...
	- Jupiter Jack was then seen carousing and getting friendly with others in the market, as well as briefly paying off some [[Hooded Lanterns]].
...
- Mobius went back to the [[James 'Ocky' Ockman]] household to plan for the show of the night.
...
- Downtime begins!
	...
	- Mobius:
		- Received a new letter:
			- Was told [[Archwizard Eldrick Runeweaver]]'s name would appear in the newspaper.
	...
	- Rupert:
		- Had a large conversation with River.
			...
			- Received all available details on how to destroy Delerium.
				...
				- There was an incident in the [[Ironhelm Mines]] of the Scar, where someone  incurred a lot of contamination and is currently in confinement of [[The Amethyst Academy]].
			- River shared openness on her intents for working with Rupert.
				...
				- Rupert mixed, not eager to do so when that incurs notoriety. River said she would speak with [[Archwizard Eldrick Runeweaver]] about doing this in a lowkey way.
			- Spoke about allegiance to [[Knights of the Silver Order]].
	...
	- Emile:
		- Visited [[Captain Ansom Lang]] regarding future events.
			- Acknowledged what the Silver Order was doing with radio jamming, rolled 21 on persuasion for making a meeting between [[High Flamekeeper Ophelia Reed]] and Captain Ansom.
	...
	- Thalia:
		- Got up, went to go see [[Flamekeeper Isaac]] viewing graffiti of Silver Order dangling people over the new brazier.
			...
			- Thalia was then told to get adequate rest and then potentially head in the direction of [[Camp Dawn]] for new training- assuming that the additional lessons from the [[Chapel of Saint Ardenna]] would be lacking by comparison.
		...
		- Sought out Honor as well as dog, ended up naming dog [[Checkers]].
			- Rolled natural twenty on animal handling, gained some loose proficiency in animal handling. Half proficiency in the skill.
			- [[Honour]] spoke about potential of her own inner light, to which Thalia looks her over and gained some understanding of existing potential was positive. Told Honor that she believes it would be used for the right reasons.
